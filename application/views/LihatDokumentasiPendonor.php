<aside class="right-side">
                    ...
                    <div class="col-md-12">
                        <div class="box box-danger" >
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Dokumentasi Pendonor</h3>
                                </div>
                                 <div class="box-body">
                                    <div id="bar-chart" style="height: 300px;"></div>
                                    <?php echo $DokumentasiPendonor['januari']->total;?>
                                    </div><!-- /.box-body-->
                            </div><!-- /.box -->
                        </div><!--col-->
                    </div><!--row-->
        ...
        <script src="<?php echo base_url();?>style/js/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
            ...
            <script type="text/javascript">   /*
                ...
                var bar_data = {
                    data: [["Januari", <?php echo $DokumentasiPendonor['januari']->total;?>], ["Februari", 0], ["Maret", 0], ["April", 0], ["Mei", 0], ["Juni", 0], ["Juli", 0], ["Agustus", 0], ["September", 0], ["Oktober", 0], ["November", 0], ["Desember", 0]],
                    color: "#F54747"
                };
