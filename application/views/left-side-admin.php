            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li >
                            <a href="<?php echo base_url();?>index.php/petugas/ListPetugas">
                                <i class="fa fa-male"></i> <span>Petugas</span> <!--<small class="badge pull-right bg-green">new</small>-->
                            </a>
                        </li>
                        <li >
                            <a href="<?php echo base_url();?>index.php/member/ListMember">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li ><a href="<?php echo base_url();?>index.php/laporanKeuangan/"><i class="fa fa-angle-double-right"></i> Keuangan</a></li>
                            </ul>
                        </li>
