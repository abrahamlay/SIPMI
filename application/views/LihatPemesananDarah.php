					...
					<div class="col-md-8">
						<div class="box box-danger" >
                                ...
                                <div class="box-body">
									...
									<div class="pagination"><?php echo $pagination; ?></div>
									<center><a href="<?php echo base_url().'index.php/pemesananDarah/inputPemesananDarah_member/'.$id;?>" class="btn btn-lg btn-flat bg-red">Input Pemesanan Darah</a></center>
